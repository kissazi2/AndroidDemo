...
public class LauncherModel extends BroadcastReceiver {
    ...
    List<InstallWidgetReceiver.WidgetMimeTypeHandlerData> resolveWidgetsForMimeType(Context context, String mimeType) {
        ...
        final List<InstallWidgetReceiver.WidgetMimeTypeHandlerData> supportedConfigurationActivities =
            new ArrayList<InstallWidgetReceiver.WidgetMimeTypeHandlerData>();
